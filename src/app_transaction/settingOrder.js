                            ...
                            <tr>
                                <td className="py-0">
                                    <div className="row mb-2">
                                        <div className={`col-sm-6 f-18 ${(this.state.activeTab == 1) ? 'text-success' : 'text-danger'}`}>
                                ...
                                <td className="py-0">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-4 text-center align-middle align-self-center">
                                            <Button
                                                size="sm"
                                                className={`btn btn-lg col-sm-8 ${(this.state.activeTab == 1) ? '  btn-success' : ' btn-danger'}`}
