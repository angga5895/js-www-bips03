        ...
        return(
            <div className="f-12">
                ...
                <div className="form-group row">
                    <div className="col-sm-6 pl-2 f-18 text-success">Sell</div>
                ...
                <div className="form-group row mb-2">
                    ...
                    <div className="col-sm-4 mr-0 ml-5 px-0 text-center align-middle align-self-center">
                        <Button size="sm" className="btn btn-lg btn-success col-sm-10" onClick={this.buttonClickPIN}>
