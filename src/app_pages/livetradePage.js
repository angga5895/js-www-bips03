    ...
    constructor(props) {
        ...
        this.state = {
            ...
            rows: [
                { time: "09:13:37",
                    code: "TLKM",
                    price: <div className="text-danger">3,879</div>,
                    change: <div className="text-danger">-20</div>,
                    percent: <div className="text-danger">-0.5</div>,
                    vol: <div className="text-danger">156,450</div>,
                    buyer: <div><span className="text-success">F</span> &nbsp;&nbsp;DE</div>,
                    seller: <div><span className="text-success">F</span> &nbsp;&nbsp;DE</div>,
                    board: "RG" },
                { time: "09:13:37",
                    code: "TLKM",
                    price: <div className="text-danger">3,879</div>,
