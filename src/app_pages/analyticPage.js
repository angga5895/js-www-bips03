...
class AnalyticPage extends React.PureComponent {
    ...
    dismissModal = () => {
        const modalDialog = document.getElementById("indicatorSettingsModal");
        ...
        const chartView = document.getElementById("allwrap");
            ...
            anychart.onDocumentReady(function () {
                ...
                $annotationType.on('change', function () {
                    ...
                    chart.listen("annotationDrawingFinish", function () {
                        $('#typeSelect').val('default').trigger('change');
    ...
    render() {
        ...
        return (
            <div>
                ...
                {/* <!-- modal alert --> */}
                < div class="modal-b fade" id="warning" tabindex="-1" role="dialog" >
                    <div class="modal-dialog-b" role="document">
                        <div class="modal-content-b">
                            <div class="modal-header-b">
                                <h4 class="modal-title-b">Attention</h4>
                            </div>
...
more.
                ...
                < div class="modal-indicator-b" id="indicatorSettingsModal" tabindex="-1" role="dialog" hidden >
                    <div class="modal-dialog-b" role="document">
                        <div class="modal-content-b" style={modalColor} >
                            <div class="modal-header-b">
                                <button type="button" class="close" onClick={this.dismissModal} data-dismiss="modal-b" aria-label="Close"><span
                                    aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title-b" id="indicatorSettingsModalTitle">Indicator Settings</h4>
                            </div>
                            <div class="modal-body-b">
                                <form id="indicatorForm" class="form"></form>
                            </div>
                            <div class="modal-footer-b">
                                <button type="button" class="btn btn-default" onClick={this.dismissModal} data-dismiss="modal-b">Close</button>
                ...
                <div id="allwrap">
                    <div class="wrapper">
                        <ul class="list list-unstyled list-nav" id="indicatorNavPanel" style={styleses}>
                            <li style={marginSelection}>
                                <input type="hidden" id="chartDataSelect" value="MSFT" data-json="./msft.json" />
                                ...
                                <select defaultValue={'default'} id="typeSelect" onclick="create()" class="select selectpicker show-tick" title="Select Annotation Type">
                            ...
                            <li style={marginSelection}>
                                <select defaultValue={'linear'} name="" class="select selectpicker show-tick" id="scaleTypeSelect" title="Scale">
                            ...
                            <li style={marginSelection}><a class="btn btn-default" href="" id="resetButton">Reset</a></li>
                        </ul>

                    </div>
                    <div id="chart-container" style={containerStyle}></div>
                </div>
            </div >
        );
    }
