...
class StockWatchlistGrid extends React.PureComponent {
    constructor(props) {
        ...
        this.state = {
            ...
            rows: [
                { code: "AALI",
                    price: <div className="text-success">3,870 &nbsp;&nbsp; <i className="icofont icofont-caret-up"></i></div>,
                    change: <div className="text-success">50</div>,
                    persen: <div className="text-success">0.2</div>,
                    tvol: <div className="text-success">156,450</div>},
                { code: "ANTM",
                    price: <div className="text-danger">3,870 &nbsp;&nbsp; <i className="icofont icofont-caret-down"></i></div>,
                    change: <div className="text-danger">50</div>,
                    persen: <div className="text-danger">0.2</div>,
                    tvol: <div className="text-danger">156,450</div>},
                { code: "BBCA",
                    price: <div className="text-danger">3,870 &nbsp;&nbsp; <i className="icofont icofont-caret-down"></i></div>,
                    change: <div className="text-danger">50</div>,
                    persen: <div className="text-danger">0.2</div>,
        ...
        this.state = {
            ...
            rows: [
                { price: <div className="text-success">10,870</div>,
                    freq: <div className="text-success">9</div>,
                    vol: <div className="text-success">20</div>,
                    value: <div className="text-success">156</div>},
                { price: <div className="text-success">10,860</div>,
                    freq: <div className="text-success">8</div>,
                    vol: <div className="text-success">21</div>,
                    value: <div className="text-success">156</div>},
                { price: <div className="text-success">10,850</div>,
                    freq: <div className="text-success">7</div>,
                    vol: <div className="text-success">22</div>,
                    value: <div className="text-success">156</div>},
                { price: <div className="text-success">10,840</div>,
                    freq: <div className="text-success">6</div>,
                    vol: <div className="text-success">23</div>,
                    value: <div className="text-success">156</div>},
                { price: <div className="text-success">10,830</div>,
                    freq: <div className="text-success">5</div>,
                    vol: <div className="text-success">24</div>,
                    value: <div className="text-success">156</div>},
                { price: <div className="text-success">10,820</div>,
                    freq: <div className="text-success">4</div>,
                    vol: <div className="text-success">25</div>,
                    value: <div className="text-success">156</div>},
                { price: <div className="text-success">10,810</div>,
                    freq: <div className="text-success">3</div>,
                    vol: <div className="text-success">26</div>,
                    value: <div className="text-success">156</div>},
                { price: <div className="text-success">10,800</div>,
                    freq: <div className="text-success">2</div>,
                    vol: <div className="text-success">27</div>,
                    value: <div className="text-success">156</div>},
            ],
            defaultColumnWidths: [
...
class HistoryBuyerGrid extends React.PureComponent {
    constructor(props) {
        ...
        this.state = {
            ...
            rows: [
                { buyer: <div className="text-warning">DX</div>,
                    volume: <div className="text-success">20</div>,
                    freq: <div className="text-success">5</div>,
                    avg: <div className="text-success">10,820</div>},
                { buyer: <div className="text-success">DX</div>,
                    volume: <div className="text-success">21</div>,
                    freq: <div className="text-success">6</div>,
                    avg: <div className="text-success">10,830</div>},
                { buyer: <div className="text-success">DX</div>,
                    volume: <div className="text-success">22</div>,
                    freq: <div className="text-success">7</div>,
                    avg: <div className="text-success">10,840</div>},
                { buyer: <div className="text-success">DX</div>,
                    volume: <div className="text-success">23</div>,
                    freq: <div className="text-success">8</div>,
                    avg: <div className="text-success">10,850</div>},
                { buyer: <div className="text-warning">DX</div>,
                    volume: <div className="text-success">24</div>,
                    freq: <div className="text-success">9</div>,
                    avg: <div className="text-success">10,860</div>},
                { buyer: <div className="text-success">DX</div>,
                    volume: <div className="text-success">25</div>,
                    freq: <div className="text-success">4</div>,
                    avg: <div className="text-success">10,870</div>},
                { buyer: <div className="text-warning">DX</div>,
                    volume: <div className="text-success">26</div>,
                    freq: <div className="text-success">3</div>,
                    avg: <div className="text-success">10,880</div>},
                { buyer: <div className="text-warning">DX</div>,
                    volume: <div className="text-success">27</div>,
                    freq: <div className="text-success">2</div>,
                    avg: <div className="text-success">10,890</div>},
            ],
            defaultColumnWidths: [
...
class HistorySellerGrid extends React.PureComponent {
    constructor(props) {
        ...
        this.state = {
            ...
            rows: [
                { seller: <div className="text-warning">DX</div>,
                    volume: <div className="text-success">20</div>,
                    freq: <div className="text-success">5</div>,
                    avg: <div className="text-success">10,820</div>},
                { seller: <div className="text-success">DX</div>,
                    volume: <div className="text-success">21</div>,
                    freq: <div className="text-success">6</div>,
                    avg: <div className="text-success">10,830</div>},
                { seller: <div className="text-success">DX</div>,
